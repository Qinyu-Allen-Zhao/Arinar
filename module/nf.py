...
class TokenNF(torch.nn.Module):
    ...
    def __init__(
        ...
        permutations = [PermutationIdentity(self.num_tokens), PermutationFlip(self.num_tokens)]
        ...
        self.register_buffer('var', torch.ones(self.num_tokens, self.token_dim))
