...
class DPM_Solver:
    ...
    def sample(self, x, condition, steps=20, t_start=None, t_end=None, order=2, skip_type='time_uniform',
        method='multistep', lower_order_final=True, denoise_to_zero=False, solver_type='dpmsolver',
        atol=0.0078, rtol=0.05, return_intermediate=False,
    ):
        """
        ...
        with torch.no_grad():
            if method == 'adaptive':
                ...
                t = timesteps[step]
                t_prev_list = [t]
                model_prev_list = [self.model_fn(x, t, condition)]
                if self.correcting_xt_fn is not None:
                ...
                for step in range(1, order):
                    ...
                    model_prev_list.append(self.model_fn(x, t, condition))
                ...
                for step in range(order, steps + 1):
                    ...
                    if step < steps:
                        model_prev_list[-1] = self.model_fn(x, t, condition)
